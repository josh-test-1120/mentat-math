        ...
        <div
            ...
            >
                ...
                <div className="mb-1">
                    ...
                    <input
                        className="rounded-lg border py-2 px-3 mb-2 w-full font-semibold
                        text-mentat-black/80 placeholder-mentat-black/50 leading-tight focus:outline-none
                        focus:shadow-outline shadow-md shadow-crimson-700 focus:border-crimson-700
                        focus:ring-crimson-700"
                        type="text"
                        name="firstname"
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        >
                            ...
                            <span className="text-mentat-black/80 font-medium">Instructor</span>
                        </label>

                        {/* Student Radio Button */}
                        <label
                            className={`flex items-center gap-3 cursor-pointer px-4 py-2 border-2 rounded-lg
                            transition-all ${
                                userType === "Student"
                        ...
                        >
                            ...
                            <span className="text-mentat-black/80 font-medium">Student</span>
                        </label>
                    </div>
                </div>
                <div className="mb-4">
