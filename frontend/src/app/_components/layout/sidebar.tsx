...
export default function Sidebar() {
    ...
    return (
        ...
        >
            ...
            {/* Navigation menu with hamburger button integrated */}
            <div 
                id="sidebar-middle" 
                className="flex-1 overflow-y-auto py-5 px-3"
            >
                {/* Hamburger button at the top of the menu */}
                <div className="mb-4 flex justify-end">
                    <button 
                        onClick={sidebarhandler}
                        className="p-2 text-yellow-300 rounded-lg hover:bg-red-500/20 transition duration-75"
                    >
                        <HamburgerSvgComponent className="w-5 h-5" />
                    </button>
                </div>
